...
As with the charts, you will notice that as you add new donations they are not appearing on the map. We can fix in a similar way.

The event hander we devised for updating the chart is as follows:
