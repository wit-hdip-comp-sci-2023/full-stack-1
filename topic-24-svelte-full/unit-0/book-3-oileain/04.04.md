...
This include for each island just a name, id (safeName) and coordinates for all islands in Ireland. This is a sample of the first few islands from this endpoint:
