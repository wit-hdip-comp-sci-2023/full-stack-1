...
As with the charts, you will notice that as you add new donations, they are not appearing on the map. We can fix this in a similar way.

The event handler we devised for updating the chart is as follows:
...
We can extend this to add a new marker to the map:
...
Try this now - you should see the map always panning to the new donation as it is added.

This is the complete donation view:
